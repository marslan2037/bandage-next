    ...
    return <header>
        <div className="header-content">
            ...
            <div className="right-section mobile-right-section">
                ...
                <p className="mobile-menu-btn" id="mobile-menu-btn">
